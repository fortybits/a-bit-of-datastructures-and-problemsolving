...
public class CountNumberSmallerThanSelf {

    // naive approach is O(n^2) iterating the remaining of the array to count numbers smaller
    // alternate could be to iterate from the last element (always 0),
    // and then create a sorted array and find the correct position of each element using binary search
    // this would result in O(n*logn)
